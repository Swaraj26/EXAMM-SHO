...
9. The script to regenerate the result plot can be accessed at \plot_fitness_sho.ipynb. The plot_fitness_sho.ipynb file contains the instructions to change the paths for result files
