...
EXAMM::EXAMM(
    ...
    //New Hyperparameters for SHO
    initial_clone_rate_min = 0.5;
    initial_clone_rate_max = 1.0;
    clone_rate_min = 0.5;
    clone_rate_max = 1.0;


    initial_add_edge_rate_min = 0.5;
    initial_add_edge_rate_max = 1.0;
    add_edge_rate_min = 0.5;
    add_edge_rate_max = 1.0;

    initial_add_recurrent_edge_rate_min = 0.5;
    initial_add_recurrent_edge_rate_max = 1.0;
    add_recurrent_edge_rate_min = 0.5;
    add_recurrent_edge_rate_max = 1.0;
        
    initial_enable_edge_rate_min = 0.5;
    initial_enable_edge_rate_max = 1.0;
    enable_edge_rate_min = 0.5;
    enable_edge_rate_max = 1.0;
        
    initial_disable_edge_rate_min = 0.5;
    initial_disable_edge_rate_max = 1.0;
    disable_edge_rate_min = 0.5;
    disable_edge_rate_max = 1.0;
        
    initial_split_edge_rate_min = 0.5;
    initial_split_edge_rate_max = 1.0;
    split_edge_rate_min = 0.5;
    split_edge_rate_max = 1.0;
        

    initial_add_node_rate_min = 0.5;
    initial_add_node_rate_max = 1.0;
    add_node_rate_min = 0.5;
    add_node_rate_max = 1.0;
        
 
    initial_enable_node_rate_min = 0.5;
    initial_enable_node_rate_max = 1.0;
    enable_node_rate_min = 0.5;
    enable_node_rate_max = 1.0;
        
  
    initial_disable_node_rate_min = 0.5;
    initial_disable_node_rate_max = 1.0;
    disable_node_rate_min = 0.5;
    disable_node_rate_max = 1.0;
        

    initial_split_node_rate_min = 0.5;
    initial_split_node_rate_max = 1.0;
    split_node_rate_min = 0.5;
    split_node_rate_max = 1.0;
        

    initial_merge_node_rate_min = 0.5;
    initial_merge_node_rate_max = 1.0;
    merge_node_rate_min = 0.5;
    merge_node_rate_max = 1.0;    
    

    //clone_rate = 1.0;
    //SY: Commented for SHO
    // add_edge_rate = 1.0;
...
void EXAMM::generate_examm_initial_hyperparameters(double &clone_rate, double &add_edge_rate, double &add_recurrent_edge_rate, double &enable_edge_rate, double &disable_edge_rate, double &split_edge_rate, double &add_node_rate, double &enable_node_rate, double &disable_node_rate, double &split_node_rate, double &merge_node_rate)
{
    clone_rate = (rng_0_1(generator) * (initial_clone_rate_max - initial_clone_rate_min)) + initial_clone_rate_min;
    add_edge_rate = (rng_0_1(generator) * (initial_add_edge_rate_max - initial_add_edge_rate_min)) + initial_add_edge_rate_min;
    add_recurrent_edge_rate = (rng_0_1(generator) * (initial_add_recurrent_edge_rate_max - initial_add_recurrent_edge_rate_min)) + initial_add_recurrent_edge_rate_min;
    enable_edge_rate = (rng_0_1(generator) * (initial_enable_edge_rate_max - initial_enable_edge_rate_min)) + initial_enable_edge_rate_min;
    disable_edge_rate = (rng_0_1(generator) * (initial_disable_edge_rate_max - initial_disable_edge_rate_min)) + initial_disable_edge_rate_min;
    split_edge_rate = 0.0;
    add_node_rate = (rng_0_1(generator) * (initial_add_node_rate_max - initial_add_node_rate_min)) + initial_add_node_rate_min;
    enable_node_rate = (rng_0_1(generator) * (initial_enable_node_rate_max - initial_enable_node_rate_min)) + initial_enable_node_rate_min;
    disable_node_rate = (rng_0_1(generator) * (initial_disable_node_rate_max - initial_disable_node_rate_min)) + initial_disable_node_rate_min;
    split_node_rate = (rng_0_1(generator) * (initial_split_node_rate_max - initial_split_node_rate_min)) + initial_split_node_rate_min;
    merge_node_rate = (rng_0_1(generator) * (initial_merge_node_rate_max - initial_merge_node_rate_min)) + initial_merge_node_rate_min;
}

void EXAMM::generate_initial_hyperparameters(double &learning_rate)
{    
    learning_rate = (rng_0_1(generator) * (initial_learning_rate_max - initial_learning_rate_min)) + initial_learning_rate_min;  
}

void EXAMM::generate_examm_simplex_hyperparameters(double &clone_rate,double &add_edge_rate, double &add_recurrent_edge_rate, double &enable_edge_rate, double &disable_edge_rate, double &split_edge_rate, double &add_node_rate, double &enable_node_rate, double &disable_node_rate, double &split_node_rate, double &merge_node_rate){
    double best_clone_rate,best_add_edge_rate,best_add_recurrent_edge_rate,best_enable_edge_rate,best_disable_edge_rate,best_split_edge_rate,best_add_node_rate,best_enable_node_rate,best_disable_node_rate,best_split_node_rate,best_merge_node_rate;
    double avg_clone_rate,avg_add_edge_rate,avg_add_recurrent_edge_rate,avg_enable_edge_rate,avg_disable_edge_rate,avg_split_edge_rate,avg_add_node_rate,avg_enable_node_rate,avg_disable_node_rate,avg_split_node_rate,avg_merge_node_rate;

    avg_clone_rate = 0;
    avg_add_edge_rate = 0;
    avg_add_recurrent_edge_rate = 0;
    avg_enable_edge_rate = 0;
    avg_disable_edge_rate = 0;
    avg_split_edge_rate = 0;
    avg_add_node_rate = 0;
    avg_enable_node_rate = 0;
    avg_disable_node_rate = 0;
    avg_split_node_rate = 0;
    avg_merge_node_rate = 0;
    ...
    for(uint32_t i=0; i<simplex_count;i++)
    {
        ...
        // RNN_Genome *current_genome = genomes[rng_0_1(generator) * genomes.size()];
        // Log::error("\n SY: Before current genome");
        // Log::error("\n SY: Island size 1: %d",speciation_strategy->get_islands_size());
        int32_t x_rnd = rng_0_1(generator) *  speciation_strategy->get_islands_size();
        // Log::error("\n SY: x_rnd = %d",x_rnd);
        // Log::error("\n SY: Island size 2: %d",speciation_strategy->get_island_at_index(x_rnd)->size());

        if(speciation_strategy->get_island_at_index(x_rnd)->size() > 0) {
            int32_t y_rnd = rng_0_1(generator) * speciation_strategy->get_island_at_index(x_rnd)->size();
        // Log::error("\n SY: y_rnd = %d", y_rnd);
        // Log::error("\n SY: During current genome");

        
        RNN_Genome *current_genome = speciation_strategy->get_island_at_index(x_rnd)->get_genome_at(y_rnd);
        // Log::error("\n SY: After current genome");
        // Log::error("\n Best Fitness Before: %lf",best_fitness);

        if( i == 0 || current_genome->get_best_validation_mse() < best_fitness)
        {
            
            best_fitness = current_genome->get_best_validation_mse();
            // Log::error("\n Best Fitness after: %lf",best_fitness);
            // Log::error("\n SY: Inside if statement after rnn genome");
            best_clone_rate = current_genome->get_initial_clone_rate();
            best_add_edge_rate = current_genome->get_initial_add_edge_rate();
            best_add_recurrent_edge_rate = current_genome->get_initial_add_recurrent_edge_rate();
            best_enable_edge_rate = current_genome->get_initial_enable_edge_rate();
            best_disable_edge_rate = current_genome->get_initial_disable_edge_rate();
            best_split_edge_rate = current_genome->get_initial_split_edge_rate();
            best_add_node_rate = current_genome->get_initial_add_node_rate();
            best_enable_node_rate = current_genome->get_initial_enable_node_rate();
            best_disable_node_rate = current_genome->get_initial_disable_node_rate();
            best_split_node_rate = current_genome->get_initial_split_node_rate();
            best_merge_node_rate = current_genome->get_initial_merge_node_rate();

            Log::error("\n SY:  Best add_edge_rate: %lf",best_add_edge_rate);
            
        }
        // Log::error("\n SY:  Before Average clone_rate ");
        avg_clone_rate += current_genome->get_initial_clone_rate();
        avg_add_edge_rate += current_genome->get_initial_add_edge_rate();
        avg_add_recurrent_edge_rate += current_genome->get_initial_add_recurrent_edge_rate();
        avg_enable_edge_rate += current_genome->get_initial_enable_edge_rate();
        avg_disable_edge_rate += current_genome->get_initial_disable_edge_rate();
        avg_split_edge_rate += current_genome->get_initial_split_edge_rate();
        avg_add_node_rate += current_genome->get_initial_add_node_rate();
        avg_enable_node_rate += current_genome->get_initial_enable_node_rate();
        avg_disable_node_rate += current_genome->get_initial_disable_node_rate();
        avg_split_node_rate += current_genome->get_initial_split_node_rate();
        avg_merge_node_rate += current_genome->get_initial_merge_node_rate();
        Log::error("\n SY: Avg add_edge_rate: %lf",avg_add_edge_rate);
        Log::error("\n SY:  After Average clone_rate ");

        }
        
    }

    avg_clone_rate /=  simplex_count;
    avg_add_edge_rate /=  simplex_count;
    avg_add_recurrent_edge_rate /=  simplex_count;
    avg_enable_edge_rate /=  simplex_count;
    avg_disable_edge_rate /=  simplex_count;
    avg_split_edge_rate /=  simplex_count;
    avg_add_node_rate /=  simplex_count;
    avg_enable_node_rate /=  simplex_count;
    avg_disable_node_rate /=  simplex_count;
    avg_split_node_rate /=  simplex_count;
    avg_merge_node_rate /=  simplex_count;
    

    double scale = (rng_0_1(generator) * 2.0) - 0.5;
    Log::error("\n SY: avg_add_edge_rate after adding avg and mul: %lf",avg_add_edge_rate);
    Log::error("\n SY: best_add_edge_rate after adding avg and mul: %lf",best_add_edge_rate);
    Log::error("\n SY: scale after adding avg and mul: %lf",scale);
    clone_rate = avg_clone_rate + ((best_clone_rate - avg_clone_rate) * scale);
    add_edge_rate = avg_add_edge_rate + ((best_add_edge_rate - avg_add_edge_rate) * scale);
    add_recurrent_edge_rate = avg_add_recurrent_edge_rate + ((best_add_recurrent_edge_rate - avg_add_recurrent_edge_rate) * scale);
    enable_edge_rate = avg_enable_edge_rate + ((best_enable_edge_rate - avg_enable_edge_rate) * scale);
    disable_edge_rate = avg_disable_edge_rate + ((best_disable_edge_rate - avg_disable_edge_rate) * scale);
    split_edge_rate = avg_split_edge_rate + ((best_split_edge_rate - avg_split_edge_rate) * scale);
    add_node_rate = avg_add_node_rate + ((best_add_node_rate - avg_add_node_rate) * scale);
    enable_node_rate = avg_enable_node_rate + ((best_enable_node_rate - avg_enable_node_rate) * scale);
    disable_node_rate = avg_disable_node_rate + ((best_disable_node_rate - avg_disable_node_rate) * scale);
    split_node_rate = avg_split_node_rate + ((best_split_node_rate - avg_split_node_rate) * scale);
    merge_node_rate = avg_merge_node_rate + ((best_merge_node_rate - avg_merge_node_rate) * scale);


    Log::error("\n SY: add_edge_rate after adding avg and mul: %lf",add_edge_rate);
    
    

    if (clone_rate < clone_rate_min) clone_rate = clone_rate_min;
    if (clone_rate > clone_rate_max) clone_rate = clone_rate_max;

    if(add_edge_rate < add_edge_rate_min) add_edge_rate = add_edge_rate_min;
    if(add_edge_rate > add_edge_rate_max) add_edge_rate = add_edge_rate_max;

    if(add_recurrent_edge_rate < add_recurrent_edge_rate_min) add_recurrent_edge_rate = add_recurrent_edge_rate_min;
    if(add_recurrent_edge_rate > add_recurrent_edge_rate_max) add_recurrent_edge_rate = add_recurrent_edge_rate_max;

    if(enable_edge_rate < enable_edge_rate_min) enable_edge_rate = enable_edge_rate_min;
    if(enable_edge_rate > enable_edge_rate_max) enable_edge_rate = enable_edge_rate_max;

    if(disable_edge_rate < disable_edge_rate_min) disable_edge_rate = disable_edge_rate_min;
    if(disable_edge_rate > disable_edge_rate_max) disable_edge_rate = disable_edge_rate_max;

    split_edge_rate = 0.0;

    if(add_node_rate < add_node_rate_min) add_node_rate = add_node_rate_min;
    if(add_node_rate > add_node_rate_max) add_node_rate = add_node_rate_max;

    if(enable_node_rate < enable_node_rate_min) enable_node_rate = enable_node_rate_min;
    if(enable_node_rate > enable_node_rate_max) enable_node_rate = enable_node_rate_max;

    if(disable_node_rate < disable_node_rate_min) disable_node_rate = disable_node_rate_min;
    if(disable_node_rate > disable_node_rate_max) disable_node_rate = disable_node_rate_max;

    if(split_node_rate < split_node_rate_min) split_node_rate = split_node_rate_min;
    if(split_node_rate > split_node_rate_max) split_node_rate = split_node_rate_max;

    if(merge_node_rate < merge_node_rate_min) merge_node_rate = merge_node_rate_min;
    if(merge_node_rate > merge_node_rate_max) merge_node_rate = merge_node_rate_max;
    Log::error("\n SY: add_edge_rate finally : %lf",add_edge_rate);
...
void EXAMM::generate_simplex_hyperparameters(double &learning_rate)
{
    ...
    for(uint32_t i=0; i<simplex_count;i++)
    {
        ...
        if( i == 0 || current_genome->get_best_validation_mse() < best_fitness)
        {
            ...
            // Log::error("\n SY:  Best learning rate: %lf",best_learning_rate);
            // best_learning_rate_delta = current_genome->get_best_learning_rate_delta();
            // best_dropout_probability = current_genome->get_best_dropout_probability();
        }
        // Log::error("\n SY:  Before Average learning rate");
        //avg_learning_rate += current_genome->get_initial_learning_rate();
        avg_learning_rate += current_genome->get_initial_learning_rate();
        // Log::error("\n SY: Avg Learning Rate: %lf",avg_learning_rate);
        // avg_learning_rate_delta += current_genome->get_initial_learning_rate_delta();
        // avg_dropout_probability += current_genome->get_initial_dropout_probability();
        // Log::error("\n SY:  After Average learning rate");
    ...
    // avg_dropout_probability /= simplex_count;

    double scale = (rng_0_1(generator) * 2.0) - 0.5;
    // Log::error("\n SY: avg_learning_rate after adding avg and mul: %lf",avg_learning_rate);
    // Log::error("\n SY: best_learning_rate after adding avg and mul: %lf",best_learning_rate);
    // Log::error("\n SY: scale after adding avg and mul: %lf",scale);
    learning_rate = avg_learning_rate + ((best_learning_rate - avg_learning_rate) * scale);

    // Log::error("\n SY: learning rate after adding avg and mul: %lf",learning_rate);
    
    // learning_rate_delta = avg_learning_rate_delta + ((best_learning_rate_delta - avg_learning_rate_delta) * scale);
    // dropout_probability = avg_dropout_probability + ((best_dropout_probability - avg_dropout_probability) * scale);
    ...
    // if (dropout_probability < dropout_probability_min) dropout_probability = dropout_probability_min;
    // if (dropout_probability > dropout_probability_max) dropout_probability = dropout_probability_max;
...
RNN_Genome* EXAMM::generate_genome(int32_t seed_genome_stirs) {
    ...
    Log::error("\n SY: add_edge_rate before calling sho function:%lf",add_edge_rate);
    generate_examm_initial_hyperparameters(clone_rate,add_edge_rate,add_recurrent_edge_rate,enable_edge_rate,disable_edge_rate,split_edge_rate,add_node_rate,enable_node_rate,disable_node_rate,split_node_rate,merge_node_rate);
    generate_examm_simplex_hyperparameters(clone_rate,add_edge_rate,add_recurrent_edge_rate,enable_edge_rate,disable_edge_rate,split_edge_rate,add_node_rate,enable_node_rate,disable_node_rate,split_node_rate,merge_node_rate);
    Log::error("\n SY: add_edge_rate after calling sho function:%lf",add_edge_rate);
    ...
    Log::error("add_edge_rate before setting in genome:%lf",genome->get_add_edge_rate());
    genome->set_clone_rate(clone_rate);
    genome->set_add_edge_rate(add_edge_rate);
    genome->set_add_recurrent_edge_rate(add_recurrent_edge_rate);
    genome->set_enable_edge_rate(enable_edge_rate);
    genome->set_disable_edge_rate(disable_edge_rate);
    genome->set_split_edge_rate(split_edge_rate);
    genome->set_add_node_rate(add_node_rate);
    genome->set_enable_node_rate(enable_node_rate);
    genome->set_disable_node_rate(disable_node_rate);
    genome->set_split_node_rate(split_node_rate);
    genome->set_merge_node_rate(merge_node_rate);
    Log::error("\nSY:LR in examm-generate-genome after sp-st-g-g %lf",genome->get_learning_rate());
    Log::error("\nSY: add_edge_rate after genome call:%lf",genome->get_add_edge_rate());
    ...
    if(speciation_strategy->islands_full() != true) {
        Log::error("SY: Island Not Full");
        genome->set_learning_rate(learning_rate);
        Log::error("SY:Island not full learning_rate %lf",genome->get_learning_rate());
    }
    else {
        // Log::error("\n SY: initialising hyperparameters");
        generate_initial_hyperparameters(learning_rate);
        // Log::error("\n SY: simplex hyperparameters");
        generate_simplex_hyperparameters(learning_rate);
        // Log::error("\n SY: learning rate before updating genome: %lf",learning_rate);
        //genome->learning_rate = learning_rate;
        genome->set_learning_rate(learning_rate);
        Log::error("\n SY: learning rate after updating genome if island full: %lf",genome->get_learning_rate());
    }

    // Log::error("SY: Island is Full");
    // Log::error("SY:Island is full learning_rate %lf",genome->get_learning_rate());
...
void EXAMM::mutate(int32_t max_mutations, RNN_Genome *g) {
    ...
    Log::error("SY: clone rate inside mutate func: %lf",clone_rate);
    bool modified = false;
