...
class RNN_Genome {
    private:
        ...
        double best_add_recurrent_edge_rate;
        ...
        uniform_real_distribution<double> rng_cr;
        uniform_real_distribution<double> rng_icr;

        uniform_real_distribution<double> rng_aer;
        uniform_real_distribution<double> rng_iaer;

        uniform_real_distribution<double> rng_arer;
        uniform_real_distribution<double> rng_iarer;

        uniform_real_distribution<double> rng_eer;
        uniform_real_distribution<double> rng_ieer;

        uniform_real_distribution<double> rng_der;
        uniform_real_distribution<double> rng_ider;

        uniform_real_distribution<double> rng_ser;
        uniform_real_distribution<double> rng_iser;

        uniform_real_distribution<double> rng_anr;
        uniform_real_distribution<double> rng_ianr;

        uniform_real_distribution<double> rng_enr;
        uniform_real_distribution<double> rng_ienr;

        uniform_real_distribution<double> rng_dnr;
        uniform_real_distribution<double> rng_idnr;

        uniform_real_distribution<double> rng_snr;
        uniform_real_distribution<double> rng_isnr;

        uniform_real_distribution<double> rng_mnr;
        uniform_real_distribution<double> rng_imnr;
    ...
    public:
        ...
        double get_dropout_probability() const;
        double get_initial_learning_rate() const;
        double get_initial_learning_rate_delta() const;
        double get_initial_dropout_probability() const;
        double get_best_learning_rate() const;
        double get_best_learning_rate_delta() const;
        double get_best_dropout_probability() const;

        //Getter and setter for new hyperparameters of SHO

        double get_clone_rate() const;
        double get_initial_clone_rate() const;
        double get_best_clone_rate() const;
        void set_clone_rate(double _clone_rate); 

        double get_add_edge_rate() const;
        double get_initial_add_edge_rate() const;
        double get_best_add_edge_rate() const;
        void set_add_edge_rate(double _add_edge_rate);

        double get_add_recurrent_edge_rate() const;
        double get_initial_add_recurrent_edge_rate() const;
        double get_best_add_recurrent_edge_rate() const;
        void set_add_recurrent_edge_rate(double _add_recurrent_edge_rate);

        double get_enable_edge_rate() const;
        double get_initial_enable_edge_rate() const;
        double get_best_enable_edge_rate() const;
        void set_enable_edge_rate(double _enable_edge_rate);

        double get_disable_edge_rate() const;
        double get_initial_disable_edge_rate() const;
        double get_best_disable_edge_rate() const;
        void set_disable_edge_rate(double _disable_edge_rate);

        double get_split_edge_rate() const;
        double get_initial_split_edge_rate() const;
        double get_best_split_edge_rate() const;
        void set_split_edge_rate(double _split_edge_rate);

        double get_add_node_rate() const;
        double get_initial_add_node_rate() const;
        double get_best_add_node_rate() const;
        void set_add_node_rate(double _add_node_rate);

        double get_enable_node_rate() const;
        double get_initial_enable_node_rate() const;
        double get_best_enable_node_rate() const;
        void set_enable_node_rate(double _enable_node_rate);

        double get_disable_node_rate() const;
        double get_initial_disable_node_rate() const;
        double get_best_disable_node_rate() const;
        void set_disable_node_rate(double _disable_node_rate);

        double get_split_node_rate() const;
        double get_initial_split_node_rate() const;
        double get_best_split_node_rate() const;
        void set_split_node_rate(double _split_node_rate);

        double get_merge_node_rate() const;
        double get_initial_merge_node_rate() const;
        double get_best_merge_node_rate() const;
        void set_merge_node_rate(double _merge_node_rate);
